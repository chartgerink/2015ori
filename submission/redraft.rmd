...
For the multivariate association analyses, we analyzed four correlations between 25 pairs of fabricated statistics (both $M$s and $SD$s) and compared this correlation to the corresponding correlation for genuine data. 
