...
The cause of such large $p$-values may be that the effect of randomness is underappreciated when fabricating statistically nonsignificant data, which results in groups of data that are too similar conditional on the null hypothesis of no differences between the groups.
...
In their classic study, @10.1126/science.185.4157.1124 varied the anchor in this question between 10% and 65% and found that they yielded mean responses of 25\% and 45\%, respectively [@doi:10.1126/science.185.4157.1124]. 
