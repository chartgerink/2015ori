...
```{r digit-dist, echo = FALSE, fig.cap="Frequency distributions of the first-, second-, and third digits. We sampled 100,000 values from a standard normal distribution to create these digit distributions.", fig.pos = 'H', fig.asp=.625}
set.seed(1234)
tmp1 <- 0
tmp2 <- 1
